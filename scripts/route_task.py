...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Recommend a Sol, Terra, or Luna agent from explicit task metadata."
    )
    parser.add_argument(
